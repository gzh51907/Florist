  ...
  methods: {
    ...
    async addCart() {
      ...
      if (username) {
        let {
          data: { data }
        } = await this.$axios.get("http://47.104.195.230:8827/carts/check", {
          params: {
            username,
        ...
        if (data.length) {
          ...
          await this.$axios.post("http://47.104.195.230:8827/carts/edit", {
            username,
            gid: this.$route.params.id,
            num
          });
          ...
          await this.$axios.post("http://47.104.195.230:8827/carts", {
            username,
            gid: this.$route.params.id,
            num: 1
          });
